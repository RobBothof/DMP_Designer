...
{
    public static void Circle(float centerX, float centerY, float Radius, float maxZ, float rotationOffset)
    {
        Vector3 center = new(centerX, centerY, 0);
        float r1 = Radius;
        float r2 = Radius * 1.084f;

        Vector3 P1 = center + Vector3.Transform(new Vector3(0, r1, maxZ*0),     Quaternion.CreateFromAxisAngle(Vector3.UnitZ, (rotationOffset + MathF.PI * 0.0f)));
        Vector3 P2 = center + Vector3.Transform(new Vector3(0, r2, maxZ*0.1f),  Quaternion.CreateFromAxisAngle(Vector3.UnitZ, (rotationOffset + MathF.PI * 0.125f)));
        Vector3 P3 = center + Vector3.Transform(new Vector3(0, r1, maxZ*0.2f),  Quaternion.CreateFromAxisAngle(Vector3.UnitZ, (rotationOffset + MathF.PI * 0.25f)));
        Vector3 P4 = center + Vector3.Transform(new Vector3(0, r2, maxZ*0.4f),  Quaternion.CreateFromAxisAngle(Vector3.UnitZ, (rotationOffset + MathF.PI * 0.375f)));
        Vector3 P5 = center + Vector3.Transform(new Vector3(0, r1, maxZ*0.6f),  Quaternion.CreateFromAxisAngle(Vector3.UnitZ, (rotationOffset + MathF.PI * 0.5f)));
        Vector3 P6 = center + Vector3.Transform(new Vector3(0, r2, maxZ*0.7f),  Quaternion.CreateFromAxisAngle(Vector3.UnitZ, (rotationOffset + MathF.PI * 0.625f)));
        Vector3 P7 = center + Vector3.Transform(new Vector3(0, r1, maxZ*0.8f),  Quaternion.CreateFromAxisAngle(Vector3.UnitZ, (rotationOffset + MathF.PI * 0.75f)));
        Vector3 P8 = center + Vector3.Transform(new Vector3(0, r2, maxZ*0.9f),  Quaternion.CreateFromAxisAngle(Vector3.UnitZ, (rotationOffset + MathF.PI * 0.875f)));
        Vector3 P9 = center + Vector3.Transform(new Vector3(0, r1, maxZ*1.0f),  Quaternion.CreateFromAxisAngle(Vector3.UnitZ, (rotationOffset + MathF.PI * 1f)));
        Vector3 P10 = center + Vector3.Transform(new Vector3(0, r2, maxZ*0.9f), Quaternion.CreateFromAxisAngle(Vector3.UnitZ, (rotationOffset + MathF.PI * 1.125f)));
        Vector3 P11 = center + Vector3.Transform(new Vector3(0, r1, maxZ*0.8f), Quaternion.CreateFromAxisAngle(Vector3.UnitZ, (rotationOffset + MathF.PI * 1.25f)));
        Vector3 P12 = center + Vector3.Transform(new Vector3(0, r2, maxZ*0.7f), Quaternion.CreateFromAxisAngle(Vector3.UnitZ, (rotationOffset + MathF.PI * 1.375f)));
        Vector3 P13 = center + Vector3.Transform(new Vector3(0, r1, maxZ*0.6f), Quaternion.CreateFromAxisAngle(Vector3.UnitZ, (rotationOffset + MathF.PI * 1.5f)));
        Vector3 P14 = center + Vector3.Transform(new Vector3(0, r2, maxZ*0.4f), Quaternion.CreateFromAxisAngle(Vector3.UnitZ, (rotationOffset + MathF.PI * 1.625f)));
        Vector3 P15 = center + Vector3.Transform(new Vector3(0, r1, maxZ*0.2f), Quaternion.CreateFromAxisAngle(Vector3.UnitZ, (rotationOffset + MathF.PI * 1.75f)));
        Vector3 P16 = center + Vector3.Transform(new Vector3(0, r2, maxZ*0.1f), Quaternion.CreateFromAxisAngle(Vector3.UnitZ, (rotationOffset + MathF.PI * 1.875f)));
        Vector3 P17 = center + Vector3.Transform(new Vector3(0, r1, maxZ*0),    Quaternion.CreateFromAxisAngle(Vector3.UnitZ, (rotationOffset + MathF.PI * 2f)));
...
public class Circles2 : IGenerator
{
    ...
    public void Generate(int seed)
    {
        ...
        for (int i = 2; i < 20000; i++)
        {
            ...
            // d1 = Math.Min(MathF.Min(cxmax, cymax), _rand.NextSingle() * 100000f+5000f);
            ...
            Shapes.Circle(center2.X+50000,center2.Y+20000,d1,4000*_rand.NextSingle()+4000,(_rand.NextSingle()*2.0f-1.0f)*MathF.PI);
        }
