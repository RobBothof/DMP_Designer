...
public class LandShape2 : IGenerator
{
    ...
    public void Generate(int seed, CancellationToken cancellationToken)
    {
        ...
        {
            Vector3 origin = new Vector3(10, -10, 2);
        ...
        {
            Vector3 origin = new Vector3(10, -10, 2);
            Vector3 pos = new Vector3(_rng.RandomFloat(), _rng.RandomFloat()*1.7f-0.85f, _rng.RandomFloat()) * 65 - origin;
            // Vector3 size = new Vector3(10, 10, 10) * (0.25f + _rng.RandomFloat() * 0.75f);
            Vector3 size = (_rng.RandomUnitVector()+new Vector3(3, 2, 1)) * 3f * (0.15f + _rng.RandomFloat() * 0.85f);
