...
public class idea001 : IGenerator {
    ...
    public void Generate(int seed) {
        ...
        for (int i=0; i < 10; i++) {
            Vector3 P = PaperCenter + Vector3.Transform(new Vector3(0, 150000 + 100000 * MathF.Cos((i/5f)*MathF.PI), 5000), Quaternion.CreateFromAxisAngle(Vector3.UnitZ, (rotationOffset + i * step)));
            Points.Add(P);
