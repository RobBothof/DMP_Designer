...
namespace Veldrid
{
    ...
    public class ImGuiRenderer : IDisposable
    {
        ...
        public ImGuiRenderer(GraphicsDevice gd, OutputDescription outputDescription, int windowWidth, int windowHeight, ColorSpaceHandling colorSpaceHandling)
        {
            ...
            style.Colors[(int)ImGuiCol.PlotHistogram]          = new Vector4(0.78f, 0.51f, 0.13f, 1.00f);
            ...
            */
            ...
            style.Colors[(int)ImGuiCol.Text] = new Vector4(0.79f, 0.79f, 0.79f, 1.00f);

            style.Colors[(int)ImGuiCol.TextDisabled] = new Vector4(0.50f, 0.50f, 0.50f, 1.00f);
            style.Colors[(int)ImGuiCol.WindowBg] = new Vector4(0.22f, 0.22f, 0.22f, 0.94f);
            style.Colors[(int)ImGuiCol.ChildBg] = new Vector4(0.18f, 0.18f, 0.18f, 0.94f);
            style.Colors[(int)ImGuiCol.PopupBg] = new Vector4(0.54f, 0.54f, 0.54f, 0.94f);
            style.Colors[(int)ImGuiCol.Border] = new Vector4(0.00f, 0.00f, 0.00f, 1.00f);
            style.Colors[(int)ImGuiCol.BorderShadow] = new Vector4(0.00f, 0.00f, 0.00f, 0.00f);
            style.Colors[(int)ImGuiCol.FrameBg] = new Vector4(0.21f, 0.21f, 0.21f, 1.00f);
            style.Colors[(int)ImGuiCol.FrameBgHovered] = new Vector4(0.18f, 0.18f, 0.18f, 1.00f);
            style.Colors[(int)ImGuiCol.FrameBgActive] = new Vector4(0.18f, 0.18f, 0.18f, 1.00f);
            style.Colors[(int)ImGuiCol.TitleBg] = new Vector4(0.29f, 0.29f, 0.29f, 1.00f);
            ...
            style.Colors[(int)ImGuiCol.MenuBarBg] = new Vector4(0.88f, 0.88f, 0.88f, 0.57f);
            style.Colors[(int)ImGuiCol.ScrollbarBg] = new Vector4(0.02f, 0.02f, 0.02f, 0.53f);
            style.Colors[(int)ImGuiCol.ScrollbarGrab] = new Vector4(0.31f, 0.31f, 0.31f, 1.00f);
            style.Colors[(int)ImGuiCol.ScrollbarGrabHovered] = new Vector4(0.41f, 0.41f, 0.41f, 1.00f);
            style.Colors[(int)ImGuiCol.ScrollbarGrabActive] = new Vector4(0.51f, 0.51f, 0.51f, 1.00f);
            style.Colors[(int)ImGuiCol.CheckMark] = new Vector4(0.67f, 0.67f, 0.67f, 1.00f);
            style.Colors[(int)ImGuiCol.SliderGrab] = new Vector4(0.53f, 0.53f, 0.53f, 1.00f);
            style.Colors[(int)ImGuiCol.SliderGrabActive] = new Vector4(0.75f, 0.75f, 0.75f, 1.00f);
            style.Colors[(int)ImGuiCol.Button] = new Vector4(0.15f, 0.15f, 0.15f, 1.00f);
            style.Colors[(int)ImGuiCol.ButtonHovered] = new Vector4(0.00f, 0.00f, 0.00f, 1.00f);
            style.Colors[(int)ImGuiCol.ButtonActive] = new Vector4(0.30f, 0.30f, 0.30f, 1.00f);
            style.Colors[(int)ImGuiCol.Header] = new Vector4(0.38f, 0.42f, 0.46f, 1.00f);
            style.Colors[(int)ImGuiCol.HeaderHovered] = new Vector4(0.33f, 0.39f, 0.45f, 1.00f);
            style.Colors[(int)ImGuiCol.HeaderActive] = new Vector4(0.64f, 0.76f, 0.83f, 0.57f);
            style.Colors[(int)ImGuiCol.Separator] = new Vector4(0.43f, 0.43f, 0.50f, 0.50f);
            ...
            style.Colors[(int)ImGuiCol.ResizeGrip] = new Vector4(0.26f, 0.59f, 0.98f, 0.20f);
            ...
            style.Colors[(int)ImGuiCol.Tab] = new Vector4(0.18f, 0.35f, 0.58f, 0.86f);
            style.Colors[(int)ImGuiCol.TabHovered] = new Vector4(0.26f, 0.59f, 0.98f, 0.80f);
            style.Colors[(int)ImGuiCol.TabActive] = new Vector4(0.20f, 0.41f, 0.68f, 1.00f);
            ...
            style.Colors[(int)ImGuiCol.PlotLines] = new Vector4(0.61f, 0.61f, 0.61f, 1.00f);
            style.Colors[(int)ImGuiCol.PlotLinesHovered] = new Vector4(1.00f, 0.43f, 0.35f, 1.00f);
            style.Colors[(int)ImGuiCol.PlotHistogram] = new Vector4(0.47f, 0.47f, 0.47f, 0.74f);
            style.Colors[(int)ImGuiCol.PlotHistogramHovered] = new Vector4(1.00f, 0.60f, 0.00f, 1.00f);
            style.Colors[(int)ImGuiCol.TableHeaderBg] = new Vector4(0.19f, 0.19f, 0.20f, 1.00f);
            style.Colors[(int)ImGuiCol.TableBorderStrong] = new Vector4(0.31f, 0.31f, 0.35f, 1.00f);
            style.Colors[(int)ImGuiCol.TableBorderLight] = new Vector4(0.23f, 0.23f, 0.25f, 1.00f);
            style.Colors[(int)ImGuiCol.TableRowBg] = new Vector4(0.00f, 0.00f, 0.00f, 0.00f);
            style.Colors[(int)ImGuiCol.TableRowBgAlt] = new Vector4(1.00f, 1.00f, 1.00f, 0.06f);
            style.Colors[(int)ImGuiCol.TextSelectedBg] = new Vector4(0.21f, 0.30f, 0.36f, 1.00f);
            style.Colors[(int)ImGuiCol.DragDropTarget] = new Vector4(1.00f, 1.00f, 0.00f, 0.90f);
            style.Colors[(int)ImGuiCol.NavHighlight] = new Vector4(0.26f, 0.59f, 0.98f, 1.00f);
            style.Colors[(int)ImGuiCol.NavWindowingHighlight] = new Vector4(1.00f, 1.00f, 1.00f, 0.70f);
            style.Colors[(int)ImGuiCol.NavWindowingDimBg] = new Vector4(0.80f, 0.80f, 0.80f, 0.20f);
