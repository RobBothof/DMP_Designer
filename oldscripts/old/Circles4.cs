...
public static class Shapes4
{
    public static void Circle4(float centerX, float centerY, float Radius, float z, float rotationOffset)
    {
...
public class Circles4 : IGenerator
{
    ...
    public void Generate(int seed)
    {
        ...
        for (int i = 2; i < 10000; i++)
        {
            ...
            d1 = _rand.NextSingle() * 25000f*Math.Abs(Math.Abs(y)-1) + 14000f;

            // Shapes2.Circle2(center2.X+50000,center2.Y+20000,d1,(Math.Abs(y)*-1+1) *4000,_rand.NextSingle()*MathF.PI*2);
            Shapes4.Circle4(center2.X+50000,center2.Y+20000,d1,Math.Abs(y)*4000,_rand.NextSingle()*MathF.PI*2);
        }
